						...
						<div class="content-wrapper"> 
							...
							<div class="entry-content">
								<?php
									...
									wp_link_pages( array(
										'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'signify-wedding' ) . '</span>',
										'after'       => '</div>',
										'link_before' => '<span class="page-number">',
										'link_after'  => '</span>',
										'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'signify-wedding' ) . ' </span>%',
										...
										<?php
											edit_post_link(
												sprintf(
													...
													esc_html__( 'Edit %s', 'signify-wedding' ),
